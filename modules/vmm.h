...
/* the size of FIQ stack page size in realtime domain */
#define RT_FIQ_STACK_PGSZ 0

/* the size of IRQ stack page size in realtime domain */
...
struct vmm_context {
	/* the status of vGuest irq, read only for realtime domain */
